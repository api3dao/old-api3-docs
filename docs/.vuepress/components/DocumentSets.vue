    ...
    docSets: [
      {
        ...
        iconInactive: '/img/01-Airnode-State=Active@2x.png',
        path: latestVersion,
      },
      {
        name: 'Beacons',
      ...
      },
      {
        ...
        iconInactive: '/img/ois-active.png',
        path: latestOisVersion,
      },
      {
        name: 'DAO Members',
        iconActive: '/img/02-DAO-State=Active@2x-1.png',
        iconInactive: '/img/02-DAO-State=Active@2x-1.png',
        path: '/dao-members/',
      },
      {
        name: 'API3',
        iconActive: '/img/03-API3-State=Active@2x-2.png',
        iconInactive: '/img/03-API3-State=Active@2x-2.png',
        path: '/api3/',
      },
    ],
    env: env,
