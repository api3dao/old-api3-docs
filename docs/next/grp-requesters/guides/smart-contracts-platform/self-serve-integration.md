...
Note that you will need to deploy both [Airnode.sol](../../../technology/protocols/request-response/general-structure.md#airnode-sol) and [Convenience.sol](../../../technology/protocols/request-response/general-structure.md#convenience-sol).
