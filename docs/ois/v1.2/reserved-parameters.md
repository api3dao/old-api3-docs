...
[template](/airnode/v0.9/concepts/template.md) that contains them, or as an
argument of the request-making methods of
[AirnodeRrpV0.sol](/airnode/v0.9/concepts/#airnoderrpv0-sol). In either case,
these parameters are encoded using the
[AirnodeRrpV0 ABI](/airnode/v0.9/reference/specifications/airnode-abi-specifications.md).
...
the
[adapter package docs](/airnode/v0.9/reference/packages/adapter.md#conversion).
...
multiplication is [cast](/airnode/v0.9/reference/packages/adapter.md) to
`int256` afterwards.
...
[testing gateway](/airnode/v0.9/grp-providers/guides/build-an-airnode/deploying-airnode.md#testing-with-http-gateway)
...
[see here](../../airnode/v0.9/grp-providers/tutorial/README.md#monorepo-examples).
