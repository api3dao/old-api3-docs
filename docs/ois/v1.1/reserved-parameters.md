...
[template](/airnode/v0.8/concepts/template.md) that contains them, or as an
argument of the request-making methods of
[AirnodeRrpV0.sol](/airnode/v0.8/concepts/#airnoderrpv0-sol). In either case,
these parameters are encoded using the
[AirnodeRrpV0 ABI](/airnode/v0.8/reference/specifications/airnode-abi-specifications.md).
...
the
[adapter package docs](/airnode/v0.8/reference/packages/adapter.md#conversion).
...
[testing gateway](/airnode/v0.8/grp-providers/guides/build-an-airnode/deploying-airnode.md#testing-with-http-gateway)
