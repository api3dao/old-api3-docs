...
The following code example validates an [OIS](/ois/v1.0/ois.md) object that has
been placed in a file separate from a `config.json` file. The OIS object
...
`ois`. The [ois.apiSpecifications](/ois/v1.0/ois.md#_4-apispecifications) object
...
The [ois.endpoints](/ois/v1.0/ois.md#_5-endpoints) object contains Airnode
...
Once you create an [OIS object](/ois/v1.0/ois.md), the convertor can
...
If you have manually created an [OIS object](/ois/v1.0/ois.md) skip this
