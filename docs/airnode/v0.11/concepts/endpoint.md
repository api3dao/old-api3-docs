...
[Oracle Integration Specifications (OIS)](/ois/v2.0/). An API is composed of
[operations](/ois/v2.0/ois.md#_5-2-operation), which represent individual
functionalities that an API offers. OIS maps each API operation to an
[endpoint](/ois/v2.0/ois.md#_5-endpoints), which can be thought of as an Airnode
