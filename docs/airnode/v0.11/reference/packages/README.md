...
[Airnode monorepo](https://github.com/api3dao/airnode/tree/v0.10/packages) has
...
[**airnode-adapter**:](https://github.com/api3dao/airnode/tree/v0.10/packages/airnode-adapter)
The module that makes an API call, processes the response and returns a single
value.

[**airnode-admin**:](https://github.com/api3dao/airnode/tree/v0.10/packages/airnode-admin)
A package/CLI tool to interact with the Airnode contracts across chains.

[**airnode-abi**:](https://github.com/api3dao/airnode/tree/v0.10/packages/airnode-abi)
...
[**airnode-examples**:](https://github.com/api3dao/airnode/tree/v0.10/packages/airnode-examples)
A public list of examples showcasing the features of Airnode.

[**airnode-node**:](https://github.com/api3dao/airnode/tree/v0.10/packages/airnode-node)
The node part of Airnode that allows for connecting multiple blockchains to the
rest of the world.

[**airnode-operation**:](https://github.com/api3dao/airnode/tree/v0.10/packages/airnode-operation)
Development and testing utilities for the core parts of Airnode.

[**airnode-protocol**:](https://github.com/api3dao/airnode/tree/v0.10/packages/airnode-protocol)
...
[Oracle Integration Specification (OIS)](/ois/v2.0/ois.md).
