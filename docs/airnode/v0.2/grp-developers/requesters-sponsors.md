...
[Admin CLI Commands](../reference/admin-cli-commands.md) package. You can also
...
1. [`sponsor-requester`](../reference/admin-cli-commands.md#sponsor-requester)
   sponsors a requester.
2. [`derive-sponsor-wallet-address`](../reference/admin-cli-commands.md#derive-sponsor-wallet-address)creates
