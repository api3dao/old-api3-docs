...
- [Build Manually](https://github.com/api3dao/airnode/tree/v0.9/packages/airnode-deployer)
...
- Make sure `config.json` and `secrets.env` are available in the `config`
  ...
  and
  [secrets.env](https://github.com/api3dao/airnode/blob/v0.9/packages/airnode-deployer/config/secrets.example.env)
