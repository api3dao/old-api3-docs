...
or the
[RequesterAuthorizerWithAirnode.sol](https://github.com/api3dao/airnode/blob/v0.9/packages/airnode-protocol/contracts/authorizers/RequesterAuthorizerWithAirnode.sol)
...
```sh
docker run api3/airnode-admin:0.9.1 --help
```

View the parameters of a command:

```sh
docker run api3/airnode-admin:0.9.1 $COMMAND --help
```
...
[test directory](https://github.com/api3dao/airnode/tree/v0.9/packages/airnode-admin/test).
