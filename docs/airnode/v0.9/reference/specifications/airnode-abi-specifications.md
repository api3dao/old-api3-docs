...
code samples in the
[examples](https://github.com/api3dao/airnode/tree/v0.9/packages/airnode-examples)
package.

- [request-utils.ts](https://github.com/api3dao/airnode/blob/v0.9/packages/airnode-examples/integrations/coingecko/request-utils.ts#L8)
