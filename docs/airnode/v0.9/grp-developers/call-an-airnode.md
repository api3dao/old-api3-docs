...
[requester examples](https://github.com/api3dao/airnode/tree/v0.9/packages/airnode-examples/contracts)
...
[RrpRequesterV0.sol](https://github.com/api3dao/airnode/blob/v0.9/packages/airnode-protocol/contracts/rrp/requesters/RrpRequesterV0.sol)
