...
There are some one-time setup/maintenance costs and some ongoing costs of calling 
an Airnode. The Airnode protocol is designed in a way that the requester assumes
...
a requester's sponsor wallet for an Airnode and when executing the Airnode 
...
provider's website and then subscribe to a level of service offered. These types of
