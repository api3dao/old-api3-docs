...
[Oracle Integration Specification (OIS)](/ois/v1.4/), executing them, parsing
...
2. The value to be converted is extracted from the response using the
   [\_path](/ois/v1.4/reserved-parameters.md#path) from the OIS object.
...
4. The converted value is encoded to the native solidity type based on the
   [\_type](/ois/v1.4/reserved-parameters.md#type) from the OIS object. Encoding
...
multiplied by the value of the [\_times](/ois/v1.4/reserved-parameters.md#times)
...
loss, you can use the [`_times`](/ois/v1.4/reserved-parameters.md#times)
