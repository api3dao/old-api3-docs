...
[requester examples](https://github.com/api3dao/airnode/tree/v0.10/packages/airnode-examples/contracts)
...
[RrpRequesterV0.sol](https://github.com/api3dao/airnode/blob/v0.10/packages/airnode-protocol/contracts/rrp/requesters/RrpRequesterV0.sol)
...
- **data**: In case of a successful response, this is the requested data which
  ...
  [timestamp](/ois/v1.4/reserved-parameters.md#timestamp-encoded-to-uint256-on-chain)
